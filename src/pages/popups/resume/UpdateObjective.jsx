...
export default function UpdateObjective({ resumeId, updateResumeValues, curentObjective }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            resumeService.updateObjective(resumeId, values.objective).then((result) => {

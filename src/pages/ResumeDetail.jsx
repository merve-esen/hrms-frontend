    ...
    <div>
              ...
              <Table celled color={"black"}>
                ...
                <Table.Body>
                  <Table.Row>
                    ...
                    <Table.Cell>
                      <Grid columns={3}>
                        <GridColumn width={10}>{resume.githubLink}</GridColumn>
                        <GridColumn width={3}>
                          {author && (
                            <Popup
                              trigger={
                        ...
                        <GridColumn width={3}>
                          {author && (
                            <Button
                              ...
                              circular
                              icon="delete"
                              onClick={() => handleGithubDelete(resume.id)}
                              disabled={!resume.githubLink}
                            ></Button>
                          )}
                        </GridColumn>
                      </Grid>
                        ...
                        <GridColumn width={3}>
                          {author && (
                            <Button
                              ...
                              icon="delete"
                              circular
                              disabled={!resume.linkedinLink}
                              onClick={() => handleLinkedinDelete(resume.id)}
                            ></Button>
                          )}
                        </GridColumn>
                      </Grid>
            ...
            {author && (
              ...
              >
                <UpdateObjective
                  resumeId={resume.id}
                  updateResumeValues={updateResumeValues}
                  curentObjective={resume.objective}
                />
              </Popup>
            )}
          </Card.Header>
          ...
          <Table.Body>
            {resume.educations?.map((education) => (
              <Table.Row key={education.id}>
                ...
                <Table.Cell>
                  {education.endYear ? education.endYear : <p>Devam Ediyor</p>}
                </Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
      ...
      <Card fluid color={"black"}>
          ...
          <Card.Header>
            ...
            {author && (
              <Popup
                ...
                modal
              >
                <UpdateProgrammingTechnologySkill
                  resumeId={resume.id}
                  updateResumeValues={updateResumeValues}
                />
              </Popup>
        ...
        <Table celled color={"black"}>
          ...
          <Table.Body>
            {resume.programmingTechnologySkills?.map(
              (programmingTechnologySkill) => (
